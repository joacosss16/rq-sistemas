-- ============================================================
-- MIGRACION 74 · 28 ago 2026 — sin transferir al costo en el piloto
--
-- COMO SE CORRE: Ctrl+A, Ctrl+C, y pegar en el editor SQL de Supabase.
-- Correr DESPUES de la 73.
--
-- AL TERMINAR (debe dar 1):
--
--   select count(*) as m74 from pg_trigger
--    where tgname = 'zz_sin_transferir_al_costo';
-- ============================================================
